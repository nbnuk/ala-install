...
<head>
    ...
    <g:if test="${grailsApplication.config.fathomId != null && grailsApplication.config.fathomId != ''}">
     ...
     <link href="${config.ala.baseURL}/shared/css-bs3/" rel="stylesheet"/>
     <asset:stylesheet src="css/application-nbn.css" />
</head>
    ...
    <nav class="navbar navbar-inverse navbar-expand-md">
        <div class="container-fluid header-logo-menu">
            ...
            <div class="navbar-header">
                <div>
                    <a href="${config.ala.baseURL}" class="custom-logo-link navbar-brand" itemprop="url">
                        <img width="138" height="26" src="${config.headerAndFooter.baseURL.replace('/commonui-bs3-v2','')}/spatial_logo.png"
                             class="custom-logo" alt="NBN Atlas spatial portal" itemprop="image"
                        ></a>
                    <!-- end custom logo -->
                </div>
